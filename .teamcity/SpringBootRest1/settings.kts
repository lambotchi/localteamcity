...
with a KProject instance or an init function as an argument, you
can also specify both of them to refine the specified KProject in
the init function.
...
version = "10.0"
project(SpringBootRest1.Project)